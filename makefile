...
GLOBAL_DEFS = USE_HAL_DRIVER STM32F4XX HSE_VALUE=25000000 STM32F437xx USE_FULL_ASSERT 
...
INC_DIRS = Inc gui emWin emWin/config freemodbus-master/port freemodbus-master/modbus/include freemodbus-master/modbus/ascii freemodbus-master/modbus/rtu ../$(STMCUBE)/Drivers/CMSIS/Include\
../$(STMCUBE)/Drivers/CMSIS/Device/ST/STM32F4xx/Include ../$(STMCUBE)/Drivers/STM32F4xx_HAL_Driver/Inc ../$(STMCUBE)/Drivers/CMSIS/Include ../$(STMCUBE)/Middlewares/ST/STemWin/inc\
../$(STMCUBE)/Middlewares/Third_Party/FatFs/src ../$(STMCUBE)/Middlewares/Third_Party/FatFs/src/drivers/sd ./drivers/display

# library directories (absolute or relative paths to additional folders with
# libraries)
LIB_DIRS = . ../$(STMCUBE)/Middlewares/ST/STemWin/Lib

# libraries (additional libraries for linking, e.g. "-lm -lsome_name" to link
# math library libm.a and libsome_name.a)
LIBS = -l_STemWin526_CM4_GCC

# additional directories with source files (absolute or relative paths to
# folders with source files, current folder is always included)
SRCS_DIRS = Src gui gui/res emWin emWin/config emWin/os freemodbus-master/port freemodbus-master/modbus freemodbus-master/modbus/rtu freemodbus-master/modbus/ascii freemodbus-master/modbus/functions\
../$(STMCUBE)/Drivers/STM32F4xx_HAL_Driver/Src ../$(STMCUBE)/Middlewares/Third_Party/FatFs/src ../$(STMCUBE)/Middlewares/Third_Party/FatFs/src/drivers/sd ./drivers/display
